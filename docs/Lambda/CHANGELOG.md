...
### Changed
- Registers now need a dollar sign before their use, so instead of using R1, use $R1
...
### Added
- New LTO instruction, works like Letter Of
- New LGO instruction, works like Length Of

### Changed
- New display writing uses memory addresses 199999 -> 198298
